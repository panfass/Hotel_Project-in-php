...
<div>&nbsp;</div>                            
			...
			<div class="content">                    
				<!-- MAIN CONTENT -->
				<h1 class="center_box_heading align_left">Παροχές Ξενοδοχείου</h1><div class="pages_contents"><img style="MARGIN-RIGHT: 7px" border="0" alt="" vspace="5" align="left" src="images\uploads\lobster-with-white-chocolate-and-pomegranate.jpg"> 
<h3 class="extra-wrap">Σημερινή Κουζίνα</h3>
<div class="extra-wrap">
<ul class="list2">
<li> 
</li><li> Φτιαγμένο απο τους Μάγειρες Μας
</li><li>  Με την υπογραφή του Άκη Πετρετζίκη
</li><li>     του γνωστού Chef απο το Mega
</li><li></li></ul></div>
<div><strong class="txt2">Μόνο €25! (τιμή ατόμου) </strong></div><br><br><br><br>
<h3><br>Γυμναστήριο</h3>

<h1 class="center_box_heading align_left"></h1><div class="pages_contents"><img style="MARGIN-RIGHT: 7px" border="0" alt="" vspace="5" align="left" src="images\uploads\Gym.jpg"> 
<h3 class="extra-wrap"></h3>
</strong></div><br><br><br><br>



<h1 class="center_box_heading align_left"<div class="pages_contents">	<h2> Επιπλέον! </h2>
    <li>Δωρεάν πρωινό σε μπουφέ</li>
    <li>Χώρος κοκτέιλ</li>
    <li>Αίθουσες εκδηλώσεων</li>
    <li>Συνεδριακοί Χώροι</li>
    <li>Ανελκυστήρας</li>
    <li>Υπηρεσία Πλυντηρίου</li>
    <li>Υπηρεσία Στεγνοκαθαριστηρίου</li>
    <li>Φύλαξη παιδιού κατόπιν συνεννόησης</li>
    <li>Ενοικιάσεις Αυτοκινήτων κατόπιν συνεννόησης</li>
    <li>Δωρεάν χώρος στάθμευσης</li>
    <li>Οργανωμένες εκδρομές με έξτρα χρέωση</li>
    <li>Γιατρός κατόπιν κλήσης</li>
    <li>Café - Μπάρ - Εστιατόριο</li>
    <li>24-ωρη ρεσεψιόν</li>
    <li>Χώρος Φύλαξης αποσκευών</li>
    <li>Υπηρεσίες Φωτοτυπίας κατόπιν αιτήματος</li>
    <li>Υπηρεσίες φαξ κατόπιν αιτήματος</li>
    <li>Ενοικίαση φορητού υπολογιστή</li>
    <li>Δωρεάν Ασύρματο Internet στο χώρο υποδοχής</li>
